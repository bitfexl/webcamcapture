...
cd ./webcamcapture/
podman build -t webcamcapture .
podlet -f -a -i --skip-services-check --overwrite podman run -p 8080:8080 -v ./webcamcaptureconfig.json:/app/webcamcaptureconfig.json -v webcam-save:/app/webcam-save/ webcamcapture
